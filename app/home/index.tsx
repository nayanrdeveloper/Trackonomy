...
export default function HomeScreen() {
  ...
  type Transaction = {
    ...
    amount: string;
    color: string;
    icon: "fast-food-outline" | "wallet-outline" | "tv-outline" | "trending-up-outline";
  };

  const transactions: Transaction[] = [
    { id: "1", title: "Food", category: "Expense", amount: "- $50.00", color: "red", icon: "fast-food-outline" },
    { id: "2", title: "Salary", category: "Income", amount: "+ $200.00", color: "teal", icon: "wallet-outline" },
    { id: "3", title: "Entertainment", category: "Expense", amount: "- $40.00", color: "red", icon: "tv-outline" },
    { id: "4", title: "Investment", category: "Income", amount: "+ $100.00", color: "teal", icon: "trending-up-outline" },
  ];
    ...
    <View className="flex-1 bg-darkBg px-4 pt-10">
      ...
      <View className="flex-row justify-between items-center mb-6">
        <View className="flex-row items-center">
          ...
          />
          <View>
            <Text className="text-white text-lg font-bold">Hi, Darshan</Text>
      ...
      {/* Stats */}
      <Text className="text-white text-lg font-bold mb-4">This month</Text>
      <View className="flex-row justify-between mb-6">
        <View className="bg-gray-800 rounded-md p-4 flex-1 mx-1">
          <Text className="text-gray-400 text-sm">Income</Text>
          <Text className="text-white text-lg font-bold">$500.00</Text>
        </View>
        <View className="bg-gray-800 rounded-md p-4 flex-1 mx-1">
        ...
        <FlatList
          ...
          renderItem={({ item }) => (
            <View className="flex-row justify-between items-center bg-gray-800 rounded-md p-4 mb-3">
              ...
              <Text className={`text-sm font-bold ${item.color === "red" ? "text-red-400" : "text-teal-400"}`}>
                {item.amount}
              </Text>
            </View>
          )}
