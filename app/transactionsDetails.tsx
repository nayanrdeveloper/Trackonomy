  ...
  return (
    <View className="flex-1 bg-darkBg px-4 pt-6">
      ...
      <View className="flex-row items-center mb-4">
        ...
        <Text className="text-white text-lg font-bold ml-4">Transaction Detail</Text>
      </View>

      {/* Card */}
      <View className="bg-gray-800 rounded-lg p-4 flex-row items-center justify-between mb-6">
        <View className="flex-row items-center">
          <Ionicons name="fast-food-outline" size={32} className="text-white" />
          <View className="ml-4">
        ...
        <View className="flex-row space-x-4">
          <TouchableOpacity onPress={() => {router.push('/editTransaction')}}>
            <Ionicons name="create-outline" size={24} className="text-teal-500" />
          </TouchableOpacity>
      ...
      <View className="bg-gray-800 rounded-lg p-4 space-y-4">
        <View>
          <Text className="text-gray-400 text-sm">Transaction Type</Text>
        ...
        <View>
          <Text className="text-gray-400 text-sm">Transaction Date</Text>
