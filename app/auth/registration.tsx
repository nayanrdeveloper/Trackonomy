  ...
  return (
    <View className="flex-1 bg-[#212129] px-4 pt-10">
      ...
      <View className="bg-[#2B2B33] rounded-3xl p-6">
        <Text className="text-white text-lg font-bold text-center mb-2">Register</Text>
        ...
        {/* Register Button */}
        <TouchableOpacity className="bg-teal-400 rounded-md py-3" onPress={() => router.push("/auth/otpVerification")}>
