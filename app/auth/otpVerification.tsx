      ...
      <View className="items-center mb-6 relative">
        <BackButton classname="absolute left-0" />
              <Image
                ...
                resizeMode="contain"
              />
              <Text className="text-teal-400 text-lg font-bold">Money tracker</Text>
            </View>

      {/* OTP Section */}
      <View className="bg-gray-800 p-6 rounded-2xl items-center">
        <Text className="text-white text-lg font-bold mb-2">OTP Verification</Text>
        ...
        {/* Verify Button */}
        <TouchableOpacity className="bg-teal-400 w-4/5 rounded-md py-3 mb-6" onPress={handleVerify}>
        ...
        <View className="flex-row items-center">
          ...
          <TouchableOpacity onPress={handleResend}>
            <Text className="text-teal-400 text-sm font-bold"> Resend</Text>
          </TouchableOpacity>
        </View>
      </View>
    </View>
