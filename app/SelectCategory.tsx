import { useRouter } from 'expo-router'; // External library import
import React, { useState } from 'react'; // React import
import { View, Text, FlatList, TouchableOpacity } from 'react-native'; // React Native components
import { Ionicons } from '@expo/vector-icons'; // Third-party icons
